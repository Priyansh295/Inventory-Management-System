    ...
    <section className='info'>
      <section className="featured-products">
        ...
        <div className="product-list">
          ...
          <img className='image' src={`${process.env.PUBLIC_URL}/images/toyota-camry.jpeg`} alt="Car 1" />
            <h3>Toyota Campry</h3>
            <p>Price: Rs:1825000.00</p>
            <Link to="/products">View Details</Link>
          </div>
          <div className="product">
          <img className='image' src={`${process.env.PUBLIC_URL}/images/chevrolet.jpeg`} alt="Car 2" />
            <h3>Chevrolet</h3>
      ...
      <section className="special-offers">
        ...
        <div className="product-list">
          ...
          {/* Example: */}
          <div className="product">
            <img className='image' src={`${process.env.PUBLIC_URL}/images/ford-150.jpeg`} alt="Special Offer 1" />
            <h3>Special Offer </h3>
