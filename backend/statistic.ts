...
export const fetch_stats_category = (req: Request, res: Response) => {
  const query = `
    SELECT
      p.Category,
...
export const fetch_stats_client_order = (req: Request, res: Response) => {
  const query = `
  ...
  db.query(query, (err, data) => {
    if (err) {
      console.error('Error fetching orders by clients:', err);
      return res.status(500).json({ error: 'Internal server error' });
    }
...
export const fetch_stats_client_product = (req: Request, res: Response) => {
  const query = `
  ...
  db.query(query, (err, data) => {
    if (err) {
      console.error('Error fetching products by clients:', err);
      return res.status(500).json({ error: 'Internal server error' });
    }
...
export const fetch_stats_products_date = (req: Request, res: Response) => {
  const query = `
...
export const fetch_stats_most_category = (req: Request, res: Response) => {
  const query = `
    SELECT
      c.Client_ID,
      c.Client_Name,
...
export const fetch_stats_monthly_products = (req: Request, res: Response) => {
  const query = `
    SELECT
...
export const fetch_stats_category_details = (req: Request, res: Response) => {
  const query = `
    SELECT
      c.Client_ID,
      c.Client_Name,
  ...
  db.query(query, (err, data) => {
    if (err) {
      console.error('Error fetching detailed category stats:', err);
      return res.status(500).json({ error: 'Internal server error' });
    }
...
export const fetch_stats_no_orders = (req: Request, res: Response) => {
  const query = `
    SELECT
      c.Client_ID,
      c.Client_Name,
  ...
  db.query(query, (err, data) => {
    if (err) {
      console.error('Error fetching clients with no orders:', err);
      return res.status(500).json({ error: 'Internal server error' });
    }
...
export const fetch_stats_most_products = (req: Request, res: Response) => {
  const query = `
    SELECT
      p.Product_ID,
      p.Product_Name,
