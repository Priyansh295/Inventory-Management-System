...
VALUES
('E0001', 'Alice Johnson', 1234567890, '123 Main Street', 'password1'),
('E0002', 'Bob Thompson', 0987654321, '456 Elm Street', 'password2'),
('E0003', 'Eva Rodriguez', 3334445555, '789 Oak Street', 'password3'),
('E0004', 'Maxwell Parker', 2225556666, '1011 Maple Avenue', 'password4'),
('E0005', 'Olivia Carter', 6667778888, '1213 Pine Street', 'password5'),
('E0006', 'Liam Foster', 5554443333, '1415 Beach Avenue', 'password6'),
('E0007', 'Sophia Bennett', 4443332222, '1617 Park Avenue', 'password7'),
('E0008', 'Daniel Nguyen', 7778881111, '1819 Elm Street', 'password8'),
('E0009', 'Isabella Kim', 8889990000, '2021 Oak Street', 'password9'),
('E0010', 'Jackson Patel', 9990001111, '2223 Maple Avenue', 'password10');
...
ADD CONSTRAINT fk_client_cart foreign key(user_id) REFERENCES client(client_id);
